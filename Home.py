...
# 1. ตั้งค่าหน้าจอ (ลบไอคอนและชื่อที่แถบ Browser ออก)
st.set_page_config(layout="wide", page_title=" ", page_icon=" ") 

st.markdown("""
    <style>
    /* ซ่อน Header แบบเด็ดขาดเพื่อลบรูปไอคอนจิ๋วที่มุมซ้าย */
    ...
    /* ดันเนื้อหาขึ้นไปทับที่เดิมของ Header */
...
# 3. Header ใหม่ (ใช้ไอคอนกราฟแท่งเทียน 📊)
...
# 5. Quick Navigation (เชื่อมไปยังชื่อไฟล์ใหม่)
