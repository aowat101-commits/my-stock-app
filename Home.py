...
# --- 2. UI SETUP & MASTER CENTERING (V13.0) ---
st.set_page_config(page_title="PPE Guardian V13.0", layout="wide", initial_sidebar_state="collapsed")
...
st.markdown("""
    ...
    /* 🔥 THE FIX: บังคับรูปภาพให้กึ่งกลางหน้าจอแบบถาวร 🔥 */
...
if st.session_state.page == 'Home':
    ...
    st.markdown(f'<div class="classic-header">{time_str} 📅 {date_str} | V13.0</div>', unsafe_allow_html=True)
    st.write('---')
    # รูปภาพจะถูกดึงเข้ากึ่งกลางด้วย CSS ชุดใหม่ใน V13.0
