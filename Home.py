...
# --- 2. UI SETUP & MASTER CENTERING (V12.9) ---
st.set_page_config(page_title="PPE Guardian V12.9", layout="wide", initial_sidebar_state="collapsed")
...
st.markdown("""
    ...
    /* บังคับกึ่งกลางทุกจุด (Hard Centering) */
    ...
    /* บังคับรูปภาพและบล็อกข้อความให้กึ่งกลาง */
    [data-testid="stImage"], [data-testid="stImage"] > img, [data-testid="stMarkdownContainer"] {
    ...
    /* ปุ่ม Add/Delete ในหน้า Watchlist */
    .manage-row {
        display: flex !important;
        justify-content: center !important;
        gap: 10px !important;
    ...
    .stExpander { margin-top: -10px !important; width: 100% !important; }
    </style>
...
if st.session_state.page == 'Home':
    st.markdown('<div class="menu-title" style="font-size:38px;">TRADING HOME</div>', unsafe_allow_html=True)
    ...
    st.markdown(f'<div class="classic-header">{time_str} 📅 {date_str} | V12.9</div>', unsafe_allow_html=True)
    st.write('---')
