...
st.markdown("""
    ...
    /* ปรับแต่งชื่อ TRADING HOME ให้พอดีกับหน้าจอมือถือ */
    .responsive-title {
        color: #fbbf24 !important;
        font-weight: bold !important;
        text-align: center;
        /* ขนาดตัวอักษรจะปรับตามความกว้างหน้าจอ (9% ของความกว้างจอ) */
...
# 2. แสดงชื่อ TRADING HOME แบบ Responsive (ไม่มีรูปภาพข้างบนแล้ว)
...
# 5. Quick Navigation (ปุ่มทางลัดเชื่อมไปยังไฟล์ชื่อเดิม)
