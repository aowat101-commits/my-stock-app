จัดให้ตามคำขอครับ ผมปรับปรุงหน้า Dashboard (หน้าที่ 2) โดยเปลี่ยนคำในช่องสัญญาณเป็น "ซื้อ" เมื่อเข้าเงื่อนไข และเปลี่ยนช่องสถานะให้โชว์ "เวลาที่เกิดสัญญาณ" แทน เพื่อให้คุณทราบแน่ชัดว่าหุ้นแต่ละตัวแจ้งเตือนมานานเท่าไรแล้วครับ

📋 โค้ดสำหรับ pages/1_Dashboard.py (เวอร์ชันอัปเดตช่องสัญญาณและเวลา)
Python
